...
def xem_hoc_sinh_kem_diem(ds_hoc_sinh):
    ds_hoc_sinh = []
    ...
    for sinh_vien in range(n):
        ...
        ngay_sinh=str(input("Ngày sinh: "))
        thang_sinh=str(input("Tháng sinh: "))
        nam_sinh=str(input("Năm sinh: "))
        ngay_thang_nam_sinh = datetime.strptime(ngay_sinh,thang_sinh,nam_sinh, '%d/%m/%Y')
        ...
        thong_tin_hoc_sinh = {"ma sinh vien":ma_sinh_vien,"ho dem":ho_dem,"ten": ten,"tuoi": tuoi,"ngay thang nam sinh":ngay_thang_nam_sinh,"so dien thoai":so_dien_thoai,"ma lop":ma_lop,"diem toan":diem_toan, "diem ly":diem_ly,"diem hoa":diem_hoa,"diem anh":diem_anh,"diem van":diem_van,"diem trung binh":diem_trung_binh,"hoc ki":hoc_ki,"nam hoc":nam_hoc,"ma hoc ki":ma_hoc_ki}
